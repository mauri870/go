...
const (
	...
	logHeapArenaBytes = (6+20)*(_64bit*(1-goos.IsWindows)*(1-(goarch.IsWasm|goarch.IsWasm32))*(1-goos.IsIos*goarch.IsArm64)) + (2+20)*(_64bit*goos.IsWindows) + (2+20)*(1-_64bit) + (2+20)*(goarch.IsWasm|goarch.IsWasm32) + (2+20)*goos.IsIos*goarch.IsArm64
